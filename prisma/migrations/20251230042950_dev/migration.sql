/*
  ...
  - Added the required column `indrustryType` to the `User` table without a default value. This is not possible if the table is not empty.
...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'COMPLETED', 'IN_REVIEW', 'BACKLOG');

-- CreateEnum
CREATE TYPE "TaskPriority" AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'CRITICAL');

-- CreateEnum
CREATE TYPE "FileTypes" AS ENUM ('IMAGE', 'PDF');
...
ADD COLUMN     "indrustryType" TEXT NOT NULL,
ADD COLUMN     "onborading" BOOLEAN NOT NULL DEFAULT false,
