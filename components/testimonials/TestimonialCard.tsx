...
export const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => (
  <div className="w-[300px] md:w-[380px] shrink-0 h-fit bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm flex flex-col gap-3">
    ...
    <div className="flex items-center gap-3 mt-1 pt-3 border-t border-slate-100 dark:border-slate-800/80">
